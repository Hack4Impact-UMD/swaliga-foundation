...
import { getInnerPolygonLayer, getOuterPolygonLayer, getPolygonBorder } from "./polygons";
...
export default function ForgotPasswordPage() {
    ...
    const setAllPolygons = (width: number, height: number): void => {
      ...
      setOuterPolygons(getOuterPolygonLayer(window.innerWidth, window.innerHeight));
      setPolygonBorder(getPolygonBorder(window.innerWidth, window.innerHeight));
      setInnerPolygons(getInnerPolygonLayer(window.innerWidth, window.innerHeight));
    }
