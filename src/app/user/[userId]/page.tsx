            ...
            <div className={styles.rightSide}>
                ...
                <div className={styles.surveysStatus}>
                    ...
                    <div className={`${styles.surveysList} ${styles.regular}`} id="list">
                        {responses?.map((completedSurveyName: string, i: number) => <a className={styles.complete} key={i}>{completedSurveyName}</a>)}
                        {surveys?.map((survey: Survey, i: number) => <a className={styles.incomplete} key={i}>{survey.info.title}</a>)}
                    </div>
                </div>
            </div>                
        </div>
