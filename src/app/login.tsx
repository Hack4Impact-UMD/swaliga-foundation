    ...
    const generatePolygons = useCallback((dims: Dims) => {
        const coords: Polygon[] = [
            { points: [
                0, 0, 
                0, dims.height / 60,
                (50/85) * dims.width, dims.height, 
                dims.width, dims.height,
                dims.width, 0.45 * dims.height,
                dims.height / 60, 0,
            ], fill: '#D0D12A' },
            { points: [
                0, dims.height / 60,
    ...
    return (
        <div className={styles.background}>
            ...
            <div className={styles.login}>
                ...
                <img className={styles.logo} src="/swaliga-website-logo.png" alt="swaliga-logo"/>
            </div>
        </div>
    );
};
...
//                 <p> image </p>
//             </div>
//             <div className={styles.login_filler}>
//             </div>
//         </div>
//     </div>
// )